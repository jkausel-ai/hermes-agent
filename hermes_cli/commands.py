...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mode", "Switch session mode: cheap, plan, code, default, or status", "Configuration",
               args_hint="[cheap|plan|code|default|status]",
               subcommands=("cheap", "plan", "code", "default", "status")),
    ...
    CommandDef("reload-config", "Reload config.yaml quick commands and skill slash commands", "Tools & Skills",
               aliases=("reload_config", "rcfg")),
    ...
    CommandDef("restart", "Gracefully restart the gateway after draining active runs", "Session",
               gateway_only=True),
    CommandDef("restart-cli", "Explain how to restart the current terminal CLI session", "Session",
               aliases=("restart_cli",), cli_only=True),
